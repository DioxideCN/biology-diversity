...
enum DeptApi {
  prefix = '/api/biology/point_manage',
}

export const PgetList = (params) => {
  return defHttp.get({ url: DeptApi.prefix + '/search', params });
};

export const PgetById = (id) => {
  return defHttp.get({ url: DeptApi.prefix +`/${id}`});
};
export const PgetAllList = () => {
...
export const PcreateOrUpdate = (params, isUpdate) => {
  // console.log(params)
