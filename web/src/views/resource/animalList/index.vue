  ...
  <div>
    ...
    >
      <div class="box">
        ...
        <div class="form-item">
          <div class="item-clo">
            <div class="text">动物知识库编号</div>
            <a-input v-model:value="k_code" class="inp" :disabled="isRead" />
          </div>
          <div class="item-clo">
        ...
        <div class="form-item-img">
          <div class="imgBox">
            ...
            <a-image :src="imgSrc || '/src/assets/images/animal.png'" alt="" class="img" width="340px" height="200px" />
          </div>
        </div>
        <div class="form-item">
          <div class="item-clo2">
          ...
          :actions="[
            {
              ...
              color: 'primary',
              onClick: show.bind(null, record, false),
            },
          ]"
        />
      </template>
...
<script lang="ts">
  ...
  import { columns, searchFormSchema, columns2, searchFormSchema2 } from './data';
  ...
  export default defineComponent({
    name: 'Animal',
    components: { BasicTable, DemoDrawer, TableAction, BasicUpload, Space, ImgUpload, Table },
    setup() {
      ...
      let isRead2 = ref(false);
      const isUpdate2 = ref<boolean>(false);
      ...
      const columnsA = [
        { title: '动物编号', dataIndex: 'animal_id', key: 'animal_id' },
      ...
      const [registerTable2,{ reload2, getSelectRows2 }] = useTable({
        api: KgetList,
        columns: columns2,
        formConfig: {
          labelWidth: 50,
      ...
      function show(record: Recordable, Read) {
        isRead2.value = Read;
        isUpdate2.value = true;
        // console.log(record, 'record');
        (k_code.value = record.code),
