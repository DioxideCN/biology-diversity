...
enum DeptApi {
  prefix = '/api/biology/animal_knowledge',
}
...
/*增加数据*/
export const increaseData = (params) => {
  return defHttp.post({ url: DeptApi.prefix, params });
};
/**
 * 保存或更新
 */
export const getAnimalName = (params) => {
  return defHttp.get({ url: '/animal_classification', params });
};
