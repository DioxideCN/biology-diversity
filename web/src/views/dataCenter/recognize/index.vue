<template>
  <div>
    ...
    >
      ...
      <video :src="card.url" class="Mvid" controls style="width: 120% margin-top:30px"></video>
    </Modal>
    <Modal
    ...
    <div class="jqbox" >
      ...
      >
        ...
        <div class="mov box"><video :src="list.url" class="lbox vbox" controls></video> </div>
        <div class="title box ebox" style="height:28px">
          <span>{{ list.cn }}</span>
          <img
        ...
        <a-button
          style="
            border-radius: 10px;
            background-color: rgb(92, 177, 101);
            border-color: rgb(92, 177, 101);
            color: #fff;
          "
          @click.stop="errorRecord()"
          >标错</a-button
        >
      </div> -->
...
<script lang="ts">
  ...
  import { Progress, Modal, Space, SelectType, Pagination } from 'ant-design-vue';
  import {
    getList,
    updateLike,
    deleteD,
  ...
  // import {exportData} from "/@/views/fuadmin/system/post/post.api";
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      function ReSet() {
        ...
        fileType.value = '';
        deviceType.value = '';
        lists2.value = resourceLists.value;
      }
      ...
      async function handleExportData() {
        ...
        await downloadByData(response.data, '实时识别信息.xlsx');
      }
      onMounted( async() => {
        getData();
        await updateSchema([
