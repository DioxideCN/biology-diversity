...
from system.apis.captcha import router as captcha_router
from system.apis.img import router as img_router
...
system_router.add_router('/', captcha_router, tags=["Captcha"])
system_router.add_router('/', img_router, tags=["Image"])